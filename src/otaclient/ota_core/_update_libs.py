...
"""Common shared libs for detailed OTA update mechanism.

Currently the following logics are implemented in this module:
1. delta calculation.
2. download results handling during downloading.
3. OTA image metadata download results handling.
4. persistents files handling.
"""
