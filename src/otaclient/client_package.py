...
class OTAClientPackagePreparer:
    ...
    def _umount_standby_slot(self) -> None:
        ...
        _standby_slot_path = _boot_controller.get_standby_slot_path()

        cmdhelper.ensure_umount(_standby_slot_path, ignore_error=False)
