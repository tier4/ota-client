...
from otaclient_api.v2 import otaclient_v2_pb2 as otaclient__v2__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in otaclient_v2_pb2_grpc.py depends on'
...
class OtaClientServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Abort = channel.unary_unary(
                ...
                request_serializer=otaclient__v2__pb2.AbortRequest.SerializeToString,
                response_deserializer=otaclient__v2__pb2.AbortResponse.FromString,
                _registered_method=True)
...
def add_OtaClientServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Abort': grpc.unary_unary_rpc_method_handler(
                    servicer.Abort,
                    request_deserializer=otaclient__v2__pb2.AbortRequest.FromString,
                    response_serializer=otaclient__v2__pb2.AbortResponse.SerializeToString,
            ),
...
class OtaClientService(object):
    ...
    def Abort(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/OtaClientV2.OtaClientService/Abort',
            otaclient__v2__pb2.AbortRequest.SerializeToString,
            otaclient__v2__pb2.AbortResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
