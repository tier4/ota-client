...
def parse_dirs_from_csv_file(
    _fpath: str, _orm: FTDirORM, *, cleanup: bool = True
) -> int:
...
def parse_symlinks_from_csv_file(
    _fpath: str, _orm: FTNonRegularORM, *, cleanup: bool = True
) -> int:
...
def parse_regulars_from_csv_file(
    _fpath: str, _orm: FTRegularORM, _orm_rs: RSTORM, *, cleanup: bool = True
) -> int:
