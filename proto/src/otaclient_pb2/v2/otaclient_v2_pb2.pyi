...
class RollbackRequest(_message.Message):
    ...
    def __init__(
        self, ecu: _Optional[_Iterable[_Union[RollbackRequestEcu, _Mapping]]] = ...
    ) -> None: ...
...
class RollbackResponse(_message.Message):
    ...
    def __init__(
        self, ecu: _Optional[_Iterable[_Union[RollbackResponseEcu, _Mapping]]] = ...
    ) -> None: ...
...
class Status(_message.Message):
    ...
    def __init__(
        ...
        progress: _Optional[_Union[StatusProgress, _Mapping]] = ...,
    ) -> None: ...
...
class StatusProgress(_message.Message):
    ...
    def __init__(
        ...
        elapsed_time_copy: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        elapsed_time_link: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        elapsed_time_download: _Optional[
            _Union[_duration_pb2.Duration, _Mapping]
        ] = ...,
        errors_download: _Optional[int] = ...,
        total_regular_file_size: _Optional[int] = ...,
        total_elapsed_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
...
class UpdateRequest(_message.Message):
    ...
    def __init__(
        self, ecu: _Optional[_Iterable[_Union[UpdateRequestEcu, _Mapping]]] = ...
    ) -> None: ...
...
class UpdateResponse(_message.Message):
    ...
    def __init__(
        self, ecu: _Optional[_Iterable[_Union[UpdateResponseEcu, _Mapping]]] = ...
    ) -> None: ...
...
class UpdateStatus(_message.Message):
    ...
    def __init__(
        ...
        total_elapsed_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        delta_generating_elapsed_time: _Optional[
            _Union[_duration_pb2.Duration, _Mapping]
        ] = ...,
        downloading_elapsed_time: _Optional[
            _Union[_duration_pb2.Duration, _Mapping]
        ] = ...,
        update_applying_elapsed_time: _Optional[
            _Union[_duration_pb2.Duration, _Mapping]
        ] = ...,
    ) -> None: ...
