...
- **For development**: Install from source code or use a released Python wheel package. See [Development Guide](DEVELOPMENT.md#development-setup).
...
> **Note:** Tests live under the `tests/` folder, organized by category:
>
