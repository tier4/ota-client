...
class OtaPartitionFile:
    """
    slot: sda2, sda3
    dev: /dev/sda2, /dev/sda3
    """
    ...
    def _create_standby_boot_kernel_files(self, rollback=False):
        ...
        standby_path = self._boot_ota_partition_file.with_suffix(f".{standby_slot}")
    ...
    def _initialize_boot_partition(self):
        ...
        standby_boot_path = boot_ota_partition.with_suffix(f".{standby_slot}")
        ...
        # update grub.cfg
        self._grub_control.update_grub_cfg(
            active_slot, "vmlinuz-ota", active_boot_path / "grub.cfg"
        )
...
###### exposed BootController implementation ######
