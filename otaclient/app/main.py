...
from .configs import config as cfg, ecu_info, logging_config, EXTRA_VERSION_FILE
from .log_setting import configure_logging, get_logger
from .ota_client_service import launch_otaclient_grpc_server

# configure logging before any code being executed
configure_logging(logging_config.LOGGING_LEVEL, http_logging_url=ecu_info.ecu_id)
