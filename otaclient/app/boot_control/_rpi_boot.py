...
class _RPIBootControl:
    ...
    CONFIG_TXT_FNAME: str = "config.txt"  # primary boot cfg
    TRYBOOT_TXT_FNAME: str = "tryboot.txt"  # tryboot boot cfg
    VMLINUZ_FNAME: str = "vmlinuz"
    INITRD_IMG_FNAME: str = "initrd.img"
    CMDLINE_TXT_FNAME: str = "cmdline.txt"
