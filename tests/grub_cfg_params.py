...
if [ x$feature_platform_search_hint = xy ]; then
  search --no-floppy --fs-uuid --set=root --hint-bios=hd0,gpt4 --hint-efi=hd0,gpt4 --hint-baremetal=ahci0,gpt4  01234567-0123-0123-0123-0123456789ab
else
...
set root='hd0,gpt3'
if [ x$feature_platform_search_hint = xy ]; then
  search --no-floppy --fs-uuid --set=root --hint-bios=hd0,gpt3 --hint-efi=hd0,gpt3 --hint-baremetal=ahci0,gpt3  76543210-3210-3210-3210-ba9876543210
else
  search --no-floppy --fs-uuid --set=root 76543210-3210-3210-3210-ba9876543210
fi
    font="/usr/share/grub/unicode.pf2"
fi
...
submenu 'Advanced options for GNU/Linux' $menuentry_id_option 'gnulinux-advanced-76543210-3210-3210-3210-ba9876543210' {
...
submenu 'Advanced options for Ubuntu 20.04.2 LTS (20.04) (on /dev/sda4)' $menuentry_id_option 'osprober-gnulinux-advanced-01234567-0123-0123-0123-0123456789ab' {
