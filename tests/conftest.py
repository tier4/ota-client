...
def ota_status_collector(
    ...
    _client_update_control_flags.notify_data_ready_event = class_mocker.MagicMock()
    _client_update_control_flags.notify_data_ready_event.is_set.return_value = False
    _client_update_control_flags.request_shutdown_event = class_mocker.MagicMock()
    _client_update_control_flags.request_shutdown_event.is_set.return_value = False
